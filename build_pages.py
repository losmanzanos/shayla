...
MARK = '''<svg class="brand__mark" viewBox="0 0 64 64" aria-hidden="true">
        ...
        <g clip-path="url(#c1)">
          ...
          <path d="M34.6 34.2 C36.9 30.3 39 28.2 41 27 C43 28.2 45.1 30.3 47.4 34.2 C45.4 32.4 43.7 31.8 42.3 32.6 C41.6 33 41 33 40.3 32.6 C38.7 31.7 36.7 32.4 34.6 34.2 Z" fill="#FBF7F2" opacity=".95"/>
...
<meta name="robots" content="noindex, nofollow"><!-- PREVIEW ONLY — remove at launch -->
